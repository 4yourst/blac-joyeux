...
@section('title', 'Modifier une option de livraison')
...
@section('content')
    ...
    <h1 class="mt-4 font-display text-3xl font-semibold text-bj-navy">Modifier l'option de livraison</h1>

    @include('admin.delivery-options._form', [
        'action' => route('admin.delivery-options.update', $deliveryOption),
        'method' => 'PATCH',
    ])
