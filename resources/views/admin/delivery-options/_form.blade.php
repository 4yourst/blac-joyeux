...
<form action="{{ $action }}" method="POST" class="mt-8 space-y-6">
    ...
    <div class="rounded-2xl border border-bj-border bg-white p-6">
        <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
            <div class="sm:col-span-2">
                <label for="zone" class="block text-xs font-medium uppercase tracking-widest text-bj-ink/60">Zone *</label>
            ...
            <div>
                <label for="delay_days" class="block text-xs font-medium uppercase tracking-widest text-bj-ink/60">Délai (jours) *</label>
            ...
            <div>
                <label for="price" class="block text-xs font-medium uppercase tracking-widest text-bj-ink/60">Tarif (FCFA) *</label>
    ...
    <div class="flex items-center gap-3">
        ...
        <a href="{{ route('admin.delivery-options.index') }}" class="text-xs font-medium uppercase tracking-widest text-bj-ink/60 transition hover:text-bj-navy">
            Annuler
        </a>
    </div>
</form>
