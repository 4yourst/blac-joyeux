...
<form action="{{ $action }}" method="POST" class="mt-8 space-y-6">
    ...
    <div class="rounded-2xl border border-bj-border bg-white p-6">
        <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
            <div>
                <label for="code" class="block text-xs font-medium uppercase tracking-widest text-bj-ink/50">Code *</label>
            ...
            <div>
                <label for="discount_percent" class="block text-xs font-medium uppercase tracking-widest text-bj-ink/50">Réduction (%) *</label>
            ...
            <div>
                <label for="starts_at" class="block text-xs font-medium uppercase tracking-widest text-bj-ink/50">Début *</label>
            ...
            <div>
                <label for="ends_at" class="block text-xs font-medium uppercase tracking-widest text-bj-ink/50">Fin *</label>
