            ...
            <div class="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div class="lg:pr-6">
                    ...
                    <div class="mt-6 flex items-center gap-3">
                        <a href="#" aria-label="Instagram" class="flex h-9 w-9 items-center justify-center rounded-full border border-white/15 text-bj-cream/80 transition hover:border-bj-gold-soft hover:text-bj-cream">
                        ...
                        <a href="#" aria-label="Facebook" class="flex h-9 w-9 items-center justify-center rounded-full border border-white/15 text-bj-cream/80 transition hover:border-bj-gold-soft hover:text-bj-cream">
                        ...
                        <a href="https://wa.me/{{ config('blacjoyaux.whatsapp_number') }}" target="_blank" rel="noopener" aria-label="WhatsApp" class="flex h-9 w-9 items-center justify-center rounded-full border border-white/15 text-bj-cream/80 transition hover:border-bj-gold-soft hover:text-bj-cream">
                            <svg class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M.057 24l1.687-6.163a11.867 11.867 0 0 1-1.587-5.945C.16 5.335 5.495 0 12.05 0a11.82 11.82 0 0 1 8.413 3.488 11.82 11.82 0 0 1 3.48 8.414c-.003 6.557-5.338 11.892-11.893 11.892a11.9 11.9 0 0 1-5.688-1.448L.057 24zm6.597-3.807c1.676.995 3.276 1.591 5.392 1.592 5.448 0 9.886-4.434 9.889-9.885.002-5.462-4.415-9.89-9.881-9.892-5.452 0-9.887 4.434-9.889 9.884a9.82 9.82 0 0 0 1.599 5.408l-.999 3.648 3.899-1.003z"/></svg>
                        </a>
                    </div>
                </div>
